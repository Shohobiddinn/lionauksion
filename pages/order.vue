            ...
            <div class="info_bottom">
              ...
              <div class="info_bottom_deliverys">
                <div class="delivery" v-for="p in order?.content" :key="p?.id">
                  ...
                  <div class="delivery_content">{{ p?.productDto?.categoryName }}</div>
                  <div class="delivery_content">
                    {{ p?.amount }}
                  </div>
                  <div class="delivery_content">
                  ...
                  <div class="delivery_content">
                    <div class="delivery_content_title icon" v-if="p?.productDto?.hasNds">
                      <svg
                        width="30"
                        height="30"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="delivery_content edit">
                    ...
                    >
                    <svg width="25" height="25" fill="green" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z"/></svg>
                    </div>
                    <div
                      class="delivery_content_title icon edit"
                    >
                    <svg width="25" height="25" fill="red" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c-9.4 9.4-9.4 24.6 0 33.9l47 47-47 47c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l47-47 47 47c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-47-47 47-47c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-47 47-47-47c-9.4-9.4-24.6-9.4-33.9 0z"/></svg>
                    </div>
                    <div
                      class="delivery_content_title icon edit"
                    >
