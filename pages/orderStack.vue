          ...
          <div class="order_info">
            ...
            <div class="order_info_bottom">
              ...
              <div class="order_info_bottom_orders">
               ...
               <NuxtLink class="order_link" :to="localePath(`/order/${c?.id}`)">
                    <div class="order_link_title">
                    <div class="order_link_title_logo">
                      <img src="../assets/image/squarelogo.svg" alt="" />
                    </div>
                  </div>
                  <div class="order_link_title">{{ c?.createdBy }}</div>
                  <div class="order_link_title">{{ c?.createdDate.slice(0,10) }}</div>
                  <div class="order_link_title">{{ c?.orderCount }}</div>
                  <div class="order_link_title lock">
                  </div>
                </NuxtLink>
                  <div class="order_link_title">
                    <div class="order_link_title_icon" @click="orderStackDelete(c?.id)">   <svg
                    width="10"
                    height="10"
                    fill="red"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    ...
                    <div class="order_link_title_icon"></div>
                  </div>
                </div>
              </div>
            </div>
